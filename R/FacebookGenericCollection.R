...
#' 
#' @param fields A character vector with the fields to get for each ID. If no value for a given fields is found, it will
#' be set to \code{NULL}.
#' 
#' @param metadata If set to \code{TRUE}, the medatata for each ID is pulled with the data and the \code{type} slot is fed accordingly.
